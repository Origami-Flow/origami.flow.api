package origami_flow.salgado_trancas_api.configuration.security;
...
import origami_flow.salgado_trancas_api.service.AutenticacaoService;
...
public class AutenticacaoFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) filterChain.doFilter(request,response);
    }
